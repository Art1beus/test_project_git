class Library {
    constructor(libTitle) {
        this.name = libTitle;
        this.books = [];
        this.totalBooks = 0; // Всего книг
        this.borrowedBooks = 0; // Всего выданных книг
    }
    // Добавляем новую книгу, если ISBN уже есть в базе, то увеличим кол-во книг (поле 'quantite)
    addBook(title, author, year, isbn, quantity = 1) {
        const newBook = {
            ...
            year: year,
            isbn: isbn,
            totalQuantity: quantity, // кол-вр экземпляров
            availableQuantity: quantity, // кол-во доступное для выдачи
            borrowedBy: [] // список читателей, взявших книгу
        }
    ...
    getBookStats() {
        ...
        const statistic = {
            ...
            issued: totalQuantity - availableQuantity, // Кол-во выданных
